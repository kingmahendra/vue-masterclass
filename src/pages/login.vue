...
const { serverError, realtimeError, handleServerError, handleLoginForm } = useFormErrors()
        ...
        <form class="grid gap-4" @submit.prevent="singin">
          <div class="grid gap-2">
            ...
            <ul class="text-sm text-left text-red-500" v-if="realtimeError?.email.length">
              <li v-for="error in realtimeError.email" class="list-disc">{{ error }}</li>
            </ul>
          </div>
          <div class="grid gap-2">
            ...
            <ul class="text-sm text-left text-red-500" v-if="realtimeError?.password.length">
              <li v-for="error in realtimeError.password" class="list-disc">{{ error }}</li>
            </ul>
          </div>
